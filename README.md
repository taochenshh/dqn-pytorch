...
SpaceInvader:
```python
python main.py --save_dir=./dqn --frame_skip=1 --memory=1000000 --hard_update_freq=10000 --gamma=0.99 --train_freq=4 --lr=0.00025 --initial_epsilon=1.0 --final_epsilon=0.1 --max_epsilon_decay_steps=1000000 --warmup_mem=50000 --max_timesteps=100000000 --save_interval=500 --render=1

python main.py --double_q --save_dir=./double_dqn --frame_skip=1 --memory=1000000 --hard_update_freq=30000 --gamma=0.99 --train_freq=4 --lr=0.00025 --initial_epsilon=1.0 --final_epsilon=0.01 --max_epsilon_decay_steps=1000000 --warmup_mem=50000 --max_timesteps=100000000 --save_interval=500 --render=1

python main.py --dueling_net --double_q --max_grad_norm=10 --save_dir=./dueling_double_dqn --frame_skip=1 --memory=1000000 --hard_update_freq=30000 --gamma=0.99 --train_freq=4 --lr=0.00025 --initial_epsilon=1.0 --final_epsilon=0.01 --max_epsilon_decay_steps=1000000 --warmup_mem=50000 --max_timesteps=100000000 --save_interval=500 --render=1
```